...
import com.execute.aws.AwsKinesisClient;
import com.execute.model.Order;
...
public class App {
    ...
    private void sendData(AmazonKinesis kinesisClient){
        ...
        //indicamos el nombre de la función que se consumirá
        recordsRequest.setStreamName("funcion_grupo4");
